...
type ChannelStore interface {
	...
	AutocompleteInTeam(teamId string, userId string, term string, includeDeleted bool) StoreChannel
	SearchInTeam(teamId string, userId string, term string, includeDeleted bool) StoreChannel
